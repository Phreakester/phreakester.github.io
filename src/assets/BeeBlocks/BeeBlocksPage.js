...
function BeeBlocksPage() {
    return (
        <div className='ppage-body'>
            <p> Over the weekend of ____, a couple friends and I participated in a design-a-thon! A design-a-thon is similar to a hack-a-thon,
            ...
            to pitching and presenting. Our entry earned honorable mention in the awards ceremony.
            </p>
